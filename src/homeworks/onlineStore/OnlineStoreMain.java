...
import homeworks.onlineStore.model.enums.OrderStatus;
import homeworks.onlineStore.model.enums.PaymentMethod;
import homeworks.onlineStore.model.enums.ProductType;
...
public class OnlineStoreMain implements Commands {
    ...
    private static void register() {
        ...
        try {
            user = new User(IdGenerator.generateId(), userDataArr[0], userDataArr[1], UserType.valueOf(userDataArr[3].toUpperCase()));
